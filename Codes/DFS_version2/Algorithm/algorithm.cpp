...
/**
 * @brief clear the visited nodes array
 */
...
/**
 * @brief Method to highlight the cells of the computed path from the current node using dfs
...
/**
 * @brief Method to clear the highlighted cells of the computed path from the current node using dfs
 *  @param stack stack that stores the computed path
 */
